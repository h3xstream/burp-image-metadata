...
public class MetadataExtractor {
    ...
    public Map<String, String> readMetadata(byte[] respBytes, int bodyOffset) throws IOException, ImageProcessingException {
        ...
        if(isPngFile(respBytes,bodyOffset)) {
    ...
    //Magic codes taken from http://en.wikipedia.org/wiki/Magic_number_(programming)#Examples
    // - http://en.wikipedia.org/wiki/Magic_number_(programming)#Examples
    ...
    public static boolean isJpgFile(byte[] respBytes,int bodyOffset) {
        ...
        return ((respBytes[bodyOffset] == (byte) 0xFF && //
                ...
                respBytes[bodyOffset+1] == (byte) 0x46 && //
                respBytes[bodyOffset+2] == (byte) 0x49 && //
                respBytes[bodyOffset+3] == (byte) 0x46) //JPEG/JFIF
                || (respBytes[bodyOffset] == (byte) 0x45 && //
                respBytes[bodyOffset+1] == (byte) 0x78 && //
                respBytes[bodyOffset+2] == (byte) 0x69 && //
                respBytes[bodyOffset+3] == (byte) 0x66));
    }
    ...
    public static boolean isPngFile(byte[] respBytes,int bodyOffset) {
        ...
        return respBytes[bodyOffset] == (byte) 0x89 && //
                ...
                respBytes[bodyOffset+3] == (byte) 0x47 && //
                respBytes[bodyOffset+4] == (byte) 0x0D && //
                respBytes[bodyOffset+5] == (byte) 0x0A && //
                respBytes[bodyOffset+6] == (byte) 0x1A && //
                respBytes[bodyOffset+7] == (byte) 0x0A;  // Magic bytes : 0x89 P N G \r \n 0x1a \n
    }
    ...
    public static boolean isGifFile(byte[] respBytes,int bodyOffset) {
        ...
        return respBytes[bodyOffset] == (byte) 0x47 && //
                ...
                respBytes[bodyOffset+3] == (byte) 0x38;
    }
